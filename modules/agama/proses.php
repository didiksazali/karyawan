...
// jika karyawan sudah login, maka jalankan perintah untuk insert, update, dan delete
else {
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            $agama = $_POST['agama'];

            // perintah query untuk menyimpan data ke tabel agama
            $query = mysqli_query($mysqli, "INSERT INTO agama VALUES('','$agama')")
    ...
    elseif ($_GET['act']=='update') {
        if (isset($_POST['simpan'])) {
            if (isset($_POST['id_agama'])) {
                ...
                // perintah query untuk mengubah data pada tabel agama
